...
//    public static Book[] makeLibrary(books) {

        //Book bookNull = new Book(null, null , 0);
        //Book bookNew = new Book("Конвой PQ-17", "В. Пикуль" , 1995);
        // Находим своболную ячейку массива:
        for (int i = 0; i < books.length; i++) {
            if (books[i].getBookName() == null) {
                books[i] = bookNew[j]; //new Book("Конвой PQ-17", "Валентин Пикуль" , 1995);;
                j++; //break;
            }
        }
